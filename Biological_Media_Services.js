...
// get the data
d3.csv("ab_per_day_BIOLOGICAL MEDIA SERVICES.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_week_BIOLOGICAL MEDIA SERVICES.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_type_BIOLOGICAL MEDIA SERVICES.csv").then(function(data) {
...
//Read the data
d3.csv("heat_csv_BIOLOGICAL MEDIA SERVICES.csv").then(function(data){
...
d3.text("table1_BIOLOGICAL MEDIA SERVICES.csv").then(function(datasetText) {
...
// Parse the Data
d3.csv("big_graph_BIOLOGICAL MEDIA SERVICES.csv").then( function(data) {

  d3.csv("big_graph_BIOLOGICAL MEDIA SERVICES2.csv",d3.autoType).then( function(data2) {
...
var renderProgress = function(el) {
  ...
  d3.csv("stats_BIOLOGICAL MEDIA SERVICES.csv",d3.autoType).then( function(data33) {
