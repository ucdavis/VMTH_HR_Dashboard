...
// get the data
d3.csv("ab_by_week_FINANCIAL SERVICES.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_type_FINANCIAL SERVICES.csv").then(function(data) {
...
d3.text("table1_FINANCIAL SERVICES.csv").then(function(datasetText) {
...
// Parse the Data
d3.csv("big_graph_FINANCIAL SERVICES.csv").then( function(data) {

  d3.csv("big_graph_FINANCIAL SERVICES2.csv",d3.autoType).then( function(data2) {
...
var renderProgress = function(el) {
  ...
  d3.csv("stats_FINANCIAL SERVICES.csv",d3.autoType).then( function(data33) {
