...
// get the data
d3.csv("ab_per_day_VMTH.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_week_VMTH.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_type_VMTH.csv").then(function(data) {
...
//Read the data
d3.csv("heat_csv_VMTH.csv").then(function(data){
...
d3.text("table1_VMTH.csv").then(function(datasetText) {
...
// Parse the Data
d3.csv("big_graph_VMTH.csv").then( function(data) {

  d3.csv("big_graph_VMTH2.csv",d3.autoType).then( function(data2) {
...
var renderProgress = function(el) {
  ...
  d3.csv("stats_VMTH.csv",d3.autoType).then( function(data33) {
