...
// get the data
d3.csv("ab_per_day_SAPCS.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_week_SAPCS.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_type_SAPCS.csv").then(function(data) {
...
//Read the data
d3.csv("heat_csv_SAPCS.csv").then(function(data){
...
d3.text("c5SAPCS.csv").then(function(datasetText) {
...
// Parse the Data
d3.csv("big_graph_SAPCS.csv").then( function(data) {

  d3.csv("big_graph_SAPCS2.csv",d3.autoType).then( function(data2) {
...
var renderProgress = function(el) {
  ...
  d3.csv("stats2_SAPCS.csv",d3.autoType).then( function(data33) {
