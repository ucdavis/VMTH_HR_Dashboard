...
// get the data
d3.csv("ab_per_day_Pharmacy.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_week_Pharmacy.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_type_Pharmacy.csv").then(function(data) {
...
//Read the data
d3.csv("heat_csv_Pharmacy.csv").then(function(data){
...
d3.text("c5Pharmacy.csv").then(function(datasetText) {
...
// Parse the Data
d3.csv("big_graph_Pharmacy.csv").then( function(data) {

  d3.csv("big_graph_Pharmacy2.csv",d3.autoType).then( function(data2) {
...
var renderProgress = function(el) {
  ...
  d3.csv("stats2_Pharmacy.csv",d3.autoType).then( function(data33) {
