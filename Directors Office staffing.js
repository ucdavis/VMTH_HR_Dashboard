...
// get the data
d3.csv("ab_per_day_Directors Office.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_week_Directors Office.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_type_Directors Office.csv").then(function(data) {
...
//Read the data
d3.csv("heat_csv_Directors Office.csv").then(function(data){
...
d3.text("c5Directors Office.csv").then(function(datasetText) {
...
// Parse the Data
d3.csv("big_graph_Directors Office.csv").then( function(data) {

  d3.csv("big_graph_Directors Office2.csv",d3.autoType).then( function(data2) {
...
var renderProgress = function(el) {
  ...
  d3.csv("stats2_Directors Office.csv",d3.autoType).then( function(data33) {
  
  var radius = 100;
  var border = 40;
  var strokeSpacing = 1.5;
  var endAngle = Math.PI * 2 * data33[0].staff_perc2
  var formatText = d3.format('.0%');
  ...
  console.log(Math.PI * 2 *data33[0].staff_perc2)
  ...
  function update(progress) {
    ...
    //update text value
    numberText.text(formatText(data33[0].staff_perc2));
