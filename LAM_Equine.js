...
// get the data
d3.csv("ab_per_day_LAM - EQUINE.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_week_LAM - EQUINE.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_type_LAM - EQUINE.csv").then(function(data) {
...
//Read the data
d3.csv("heat_csv_LAM - EQUINE.csv").then(function(data){
...
d3.text("table1_LAM - EQUINE.csv").then(function(datasetText) {
...
// Parse the Data
d3.csv("big_graph_LAM - EQUINE.csv").then( function(data) {

  d3.csv("big_graph_LAM - EQUINE2.csv",d3.autoType).then( function(data2) {
...
var renderProgress = function(el) {
  ...
  d3.csv("stats_LAM - EQUINE.csv",d3.autoType).then( function(data33) {
