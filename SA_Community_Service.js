...
// get the data
d3.csv("ab_per_day_SA COMMUNITY SERVICE.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_week_SA COMMUNITY SERVICE.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_type_SA COMMUNITY SERVICE.csv").then(function(data) {
...
//Read the data
d3.csv("heat_csv_SA COMMUNITY SERVICE.csv").then(function(data){
...
d3.text("table1_SA COMMUNITY SERVICE.csv").then(function(datasetText) {
...
// Parse the Data
d3.csv("big_graph_SA COMMUNITY SERVICE.csv").then( function(data) {

  d3.csv("big_graph_SA COMMUNITY SERVICE2.csv",d3.autoType).then( function(data2) {
...
var renderProgress = function(el) {
  ...
  d3.csv("stats_SA COMMUNITY SERVICE.csv",d3.autoType).then( function(data33) {
