...
// get the data
d3.csv("ab_per_day_Receiving.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_week_Receiving.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_type_Receiving.csv").then(function(data) {
...
//Read the data
d3.csv("heat_csv_Receiving.csv").then(function(data){
...
d3.text("c5Receiving.csv").then(function(datasetText) {
...
// Parse the Data
d3.csv("big_graph_Receiving.csv").then( function(data) {

  d3.csv("big_graph_Receiving2.csv",d3.autoType).then( function(data2) {
...
var renderProgress = function(el) {
  ...
  d3.csv("stats2_Receiving.csv",d3.autoType).then( function(data33) {
