...
// get the data
d3.csv("ab_per_day_LA Clinic.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_week_LA Clinic.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_type_LA Clinic.csv").then(function(data) {
...
//Read the data
d3.csv("heat_csv_LA Clinic.csv").then(function(data){
...
d3.text("c5LA Clinic.csv").then(function(datasetText) {
...
// Parse the Data
d3.csv("big_graph_LA Clinic.csv").then( function(data) {

  d3.csv("big_graph_LA Clinic2.csv",d3.autoType).then( function(data2) {
...
var renderProgress = function(el) {
  ...
  d3.csv("stats2_LA Clinic.csv",d3.autoType).then( function(data33) {
