...
// get the data
d3.csv("ab_per_day_Imaging.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_week_Imaging.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_type_Imaging.csv").then(function(data) {
...
//Read the data
d3.csv("heat_csv_Imaging.csv").then(function(data){
...
d3.text("c5Imaging.csv").then(function(datasetText) {
...
// Parse the Data
d3.csv("big_graph_Imaging.csv").then( function(data) {

  d3.csv("big_graph_Imaging2.csv",d3.autoType).then( function(data2) {
...
var renderProgress = function(el) {
  ...
  d3.csv("stats2_Imaging.csv",d3.autoType).then( function(data33) {
