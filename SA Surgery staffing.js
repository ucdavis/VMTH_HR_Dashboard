...
// get the data
d3.csv("ab_per_day_SA Surgery.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_week_SA Surgery.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_type_SA Surgery.csv").then(function(data) {
...
//Read the data
d3.csv("heat_csv_SA Surgery.csv").then(function(data){
...
d3.text("c5SA Surgery.csv").then(function(datasetText) {
...
// Parse the Data
d3.csv("big_graph_SA Surgery.csv").then( function(data) {

  d3.csv("big_graph_SA Surgery2.csv",d3.autoType).then( function(data2) {
...
var renderProgress = function(el) {
  ...
  d3.csv("stats2_SA Surgery.csv",d3.autoType).then( function(data33) {
