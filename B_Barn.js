...
// get the data
d3.csv("ab_per_day_B BARN.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_week_B BARN.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_type_B BARN.csv").then(function(data) {
...
//Read the data
d3.csv("heat_csv_B BARN.csv").then(function(data){
...
d3.text("table1_B BARN.csv").then(function(datasetText) {
...
// Parse the Data
d3.csv("big_graph_B BARN.csv").then( function(data) {

  d3.csv("big_graph_B BARN2.csv",d3.autoType).then( function(data2) {
...
var renderProgress = function(el) {
  ...
  d3.csv("stats_B BARN.csv",d3.autoType).then( function(data33) {
