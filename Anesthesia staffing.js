...
// get the data
d3.csv("ab_per_day_Anesthesia.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_week_Anesthesia.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_type_Anesthesia.csv").then(function(data) {
...
//Read the data
d3.csv("heat_csv_Anesthesia.csv").then(function(data){
...
d3.text("c5Anesthesia.csv").then(function(datasetText) {
...
// Parse the Data
d3.csv("big_graph_Anesthesia.csv").then( function(data) {

  d3.csv("big_graph_Anesthesia2.csv",d3.autoType).then( function(data2) {
...
var renderProgress = function(el) {
  ...
  d3.csv("stats2_Anesthesia.csv",d3.autoType).then( function(data33) {
