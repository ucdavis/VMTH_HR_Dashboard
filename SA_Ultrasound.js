...
// get the data
d3.csv("ab_per_day_SA ULTRASOUND.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_week_SA ULTRASOUND.csv").then(function(data) {
...
// get the data
d3.csv("ab_by_type_SA ULTRASOUND.csv").then(function(data) {
...
//Read the data
d3.csv("heat_csv_SA ULTRASOUND.csv").then(function(data){
...
d3.text("table1_SA ULTRASOUND.csv").then(function(datasetText) {
...
// Parse the Data
d3.csv("big_graph_SA ULTRASOUND.csv").then( function(data) {

  d3.csv("big_graph_SA ULTRASOUND2.csv",d3.autoType).then( function(data2) {
...
var renderProgress = function(el) {
  ...
  d3.csv("stats_SA ULTRASOUND.csv",d3.autoType).then( function(data33) {
